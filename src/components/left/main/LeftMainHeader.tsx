...
import MainMenuButton from '../../navigation/MainMenuButton';
...
const LeftMainHeader: FC<OwnProps & StateProps> = ({
  ...
  const hasMenu = !hasFolders || isMobile;
  const isHamburgerMenu = content === LeftColumnContent.ChatList;
    ...
    <div className="LeftMainHeader">
      <div id="LeftMainHeader" className="left-header" ref={headerRef}>
        ...
        <SearchInput
          ...
          autoComplete="off"
          canClose={!hasMenu && isSearchRelevant}
